...
const prebuiltSites = [
  ...
  },
  {
    ...
    features: ["Chef portfolio & bio", "Menu showcase", "Booking form", "Client testimonials", "Contact form", "Stripe deposit integration ", "Mobile responsive", "Domain & hosting setup",
  "SEO setup & Google Analytics",
  "2 rounds of revisions",
  "30-day post-launch support",],
  ...
  },
  {
    ...
    features: ["Service packages", "Photo gallery", "Inquiry form", "Pricing display", "Stripe deposit integration ", "Contact form", "Mobile responsive", "Domain & hosting setup",
  "SEO setup & Google Analytics",
  "2 rounds of revisions",
  "30-day post-launch support",],
  ...
  // Health & Fitness
  {
    ...
    color: "from-green-500/20 to-emerald-500/20",
    features: ["Class schedule display", "Membership plans", "Trainer profiles", "Before/after gallery", "Contact form","Admin dashboard", "Stripe payment integration ", "Booking integration ready", "Domain & hosting setup",
  "SEO setup & Google Analytics",
  "2 rounds of revisions",
  "30-day post-launch support",],
  ...
  },
  {
    ...
    features: ["Trainer bio & credentials", "Program packages", "Transformation gallery", "Booking form", "Stripe payment integration ", "Contact form", "Mobile responsive", "Domain & hosting setup",
  "SEO setup & Google Analytics",
  "2 rounds of revisions",
  "30-day post-launch support",],
  ...
  // Tech & SaaS
  {
    ...
    features: ["Feature showcase", "Pricing tiers", "Stripe subscription integration ", "Demo CTA", "Testimonials", "FAQ section", "Analytics ready", "Domain & hosting setup",
  "SEO setup & Google Analytics",
  "2 rounds of revisions",
  "30-day post-launch support",],
  ...
  },
  {
    ...
    features: ["Product showcase", "Team profiles", "Portfolio section", "Pricing plans","Stripe subscription integration", "Contact form", "Mobile responsive", "Domain & hosting setup",
  "SEO setup & Google Analytics",
  "2 rounds of revisions",
  "30-day post-launch support",],
  ...
  // Startups & Business
  {
    ...
    features: ["Product pitch section", "Team profiles", "Investor info", "Roadmap display", "Contact form","Stripe subscription integration ", "Mobile responsive", "Domain & hosting setup",
  "SEO setup & Google Analytics",
  "2 rounds of revisions",
  "30-day post-launch support",],
  ...
  },
  {
    ...
    features: ["Product catalog", "Shopping cart", "Checkout integration","Shopify or WooCommerce setup", "Customer reviews", "Category filtering", "Inventory management", "Domain & hosting setup",
  "SEO setup & Google Analytics",
  "2 rounds of revisions",
  "30-day post-launch support",],
